...
public class GameView3 extends SurfaceView implements Runnable {
    ...
    public GameView3(Context context, int screenX, int screenY) {
        super(context);
    ...
    private void update() {
        ...
        enemies1.update(basket.getSpeed());
        //enemies2.update(basket.getSpeed());
        enemies3.update(basket.getSpeed());
        //enemies4.update(basket.getSpeed());
        enemies5.update(basket.getSpeed());
//        enemies6.update(basket.getSpeed());
...
//        }
    ...
    private void draw() {
        if (surfaceHolder.getSurface().isValid()) {
            ...
            canvas.drawBitmap(BitmapFactory.decodeResource(getResources(),R.drawable.p4_min),0,0,null);
...
//            );
            ...
            if(!isGameOver){
                ...
                canvas.drawText("Level 1 Clear",screenX/2,300,paint);
...
//
//                paint.setTextSize(80);
//                canvas.drawText("Tap to play",screenX/2,600,paint);
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if(isGameOver&&score<targetScore){
            if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                context.startActivity(new Intent(context,GameActivity3.class));

            }
        } else if(isGameOver&&score>=targetScore){
            if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                context.startActivity(new Intent(context,GameActivity2.class));
